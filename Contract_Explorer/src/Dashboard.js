...
import unisysLogo from "./unisys_text_logo.png";
import {
  Button,
  TextField,
  Typography,
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 3 }}>
        <Grid container spacing={3}>
          <Grid item xs={12} md={6}>
            ...
            {caseDetails && (
              <Alert
                severity={caseDetails.isOpen ? "info" : "warning"}
        ...
        <AppBar position="static" color="primary" elevation={4}>
          <Toolbar>
            ...
            <Typography
              variant="h5"
              component="div"
              sx={{ flexGrow: 1, textAlign: "center", paddingLeft: 15 }}
            >
              Contract Explorer
            </Typography>
          ...
          {!account ? (
            <Paper elevation={3} sx={{ p: 4, textAlign: "center" }}>
              <Typography variant="h5" gutterBottom>
                Welcome to our Custom Contract Explorer
              </Typography>
              <Typography variant="body1" paragraph>
                This is a blockchain-based crime lifecycle management system.
